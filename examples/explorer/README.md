...
The live pages make no Sefaria request when opened. Select **Start live demo** or an example preset to call the public client plus the named async factory. They keep transport errors visible, do not replace failures with fixture success, and pass request-free elements only view models and display properties:

- [Text segment](text-segment.html): `@arithmomaniac/sefaria-web-components/text-segment`
- [Bilingual segment](bilingual-segment.html): `@arithmomaniac/sefaria-web-components/bilingual-segment`
- [Reference label](ref-label.html): `@arithmomaniac/sefaria-web-components/ref-label`
- [Source card](source-card.html): `@arithmomaniac/sefaria-web-components/source-card`
