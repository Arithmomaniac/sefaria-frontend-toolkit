...
| --- | --- | --- |
| How do requests, factories, view models, and elements fit together? | [How the pieces fit together](data-flow.md) | Request and validation boundaries, supplied-data flow, failures, and composition |
...
For a guided sequence, use [Get started](../get-started.md). For exact element declarations and package exports, use the [API reference](../reference/custom-elements.md). For project setup, evidence, specifications, and review gates, use the [contributor and internals documentation map](../reference/documentation-map.md).
